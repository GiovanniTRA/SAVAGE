...
def attack(cfg):
    ...
    os.makedirs("../support_materials/results/savage/", exist_ok=True)
    with open(f"../support_materials/results/savage/"
              f"{cfg.data_name}_pen_edg_{cfg.pen_edg}_pen_fn_{cfg.pen_fn}_max_fn_{cfg.max_fn}_"
              f"n_steps_{cfg.n_steps}_X_existent_{cfg.X_existent}_import_init_{cfg.import_init}.txt", "w") as f:
