...
def attack(cfg):
    ...
    os.makedirs("../support_materials/results/ablations/pen_edg/", exist_ok=True)
    with open(f"../support_materials/results/ablations/pen_edg/"
              f"{cfg.data_name}_pen_edg_{cfg.pen_edg}_n_steps_{cfg.n_steps}.txt", "w") as f:
